...
import TheS3Manager from "./s3admin/TheS3Manager.vue";
import TheUserProfile from "./s3admin/TheUserProfile.vue";
...
async function checkPermission() {
    ...
    if (userInfo.value.permission !== 's3Admin') {
